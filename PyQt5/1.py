...
class UserManager(QMainWindow):
    ...
    def setupModelView(self):
        ...
        new_user_button = QPushButton(QIcon("images/plus.png"), "Create NewUser")
        new_user_button.setMaximumWidth(160)
        new_user_button.clicked.connect(self.createNewUserDialog)
        self.list_of_table_headers = ["First Name", "Last Name", "ProfileName", "Location"]
    ...
    def createNewUserDialog(self):
        """Set up the dialog box that allows the user to enter new user
        information."""
        ...
        locations_list = ["Select Location...", "Algeria", "Argentina","Bolivia", "Canada", "Denmark", "Greece", "Iran", "Liberia", "NewZealand", "Qatar", "Uganda"]
    ...
    def addNewUserToTable(self):
        """Add information from input widgets in dialog box to a list. If a
        widget is empty, append None to the list. Finally, add a new row to
        the table."""
        new_user_info_list = []
